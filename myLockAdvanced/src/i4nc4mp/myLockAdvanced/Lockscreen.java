...
/* Lifecycle flags */
    ...
    protected void onCreate(Bundle icicle) {
       ...
       updateClock();
		...
		IntentFilter callbegin = new IntentFilter ("i4nc4mp.myLockAdvanced.lifecycle.CALL_START");
        registerReceiver(callStarted, callbegin);  
        
        IntentFilter callabort = new IntentFilter ("i4nc4mp.myLockAdvanced.lifecycle.CALL_ABORT");
...
BroadcastReceiver callStarted = new BroadcastReceiver() {
	@Override
    public void onReceive(Context context, Intent intent) {
	if (!intent.getAction().equals("i4nc4mp.myLockAdvanced.lifecycle.CALL_START")) return;
...
BroadcastReceiver callAborted = new BroadcastReceiver() {
   	@Override
       public void onReceive(Context context, Intent intent) {
  	if (!intent.getAction().equals("i4nc4mp.myLockAdvanced.lifecycle.CALL_ABORT")) return;
...
02-02 13:32:12.788: WARN/UsageStats(1019): Something wrong here, didn't expect i4nc4mp.myLockAdvanced to be resumed
 ...
 */
    ...
    public void StartCallback() {
    	Intent i = new Intent("i4nc4mp.myLockAdvanced.lifecycle.LOCKSCREEN_PRIMED");
        getApplicationContext().sendBroadcast(i);
    }
    
    public void StopCallback() {
    	Intent i = new Intent("i4nc4mp.myLockAdvanced.lifecycle.LOCKSCREEN_EXITED");
        getApplicationContext().sendBroadcast(i);
    }
