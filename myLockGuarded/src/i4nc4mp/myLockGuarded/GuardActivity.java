...
//the activity sends call start broadcast back to us as soon as it gains focus
//then sends self to back and exits too
//TODO need to import that ver of the dismiss activity code from basic ver
    	...
    	if (hasFocus) {
    		...
    		if (!finishing && paused) {
   				if (!dormant) {
   					...
   					//Intent i = new Intent("i4nc4mp.myLockGuarded.lifecycle.HOMEKEY_UNLOCK");
