...
public class UserPresentService extends Service {
	...
	BroadcastReceiver unlockdone = new BroadcastReceiver() {
	    ...
	    public void onReceive(Context context, Intent intent) {
			...
			i.setClassName("i4nc4mp.myLockAdvanced", "i4nc4mp.myLockAdvanced.CustomLockService");
	    	//i.setClassName("i4nc4mp.myLockAdvanced", "i4nc4mp.myLockAdvanced.SecureLockService");
			startService(i);
	    	//call stopSelf
			stopSelf();
	    	return;
