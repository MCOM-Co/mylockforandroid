...
public class SettingsActivity extends Activity {
      ...
      getPrefs();//grabs our user's current settings for startup commands
       ...
       shake.setOnClickListener(new OnClickListener() {
                   ...
                   public void onClick(View v) {
                       ...
                       Intent i = new Intent();
               			i.setClassName("i4nc4mp.myLockAdvanced", "i4nc4mp.myLockAdvanced.ShakeWakeupService");
    ...
    private void startService(){
   			Intent i = new Intent();
   			//if (!customLock) i.setClassName("i4nc4mp.myLockAdvanced", "i4nc4mp.myLockAdvanced.LockSkipService");
   			if (secure) i.setClassName("i4nc4mp.myLockAdvanced", "i4nc4mp.myLockAdvanced.SecureLockService");
