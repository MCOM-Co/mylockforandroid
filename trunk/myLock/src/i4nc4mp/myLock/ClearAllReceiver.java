...
public class ClearAllReceiver extends BroadcastReceiver {
  ...
  /*
   * I am never going to pass re-enable because my service already makes this happen when it needs to
   */
  ...
  public static synchronized void setCancel(Context context, int timeout) {
    ...
    myAM.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + (timeout * 100),
