...
public class ToggleWidget extends AppWidgetProvider {
	...
	//"i4nc4mp.myLockcomplete.intent.action.TOGGLE_LOCKSCREEN"
  ...
  public void onEnabled(Context context) {	
		...
		Intent i = new Intent();
		i.setClassName("i4nc4mp.myLockcomplete", "i4nc4mp.myLockcomplete.Toggler");
	...
	public void onUpdate (Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
		...
		//Intent clickintent = new Intent ("i4nc4mp.myLockcomplete.intent.action.TOGGLE_LOCKSCREEN");
