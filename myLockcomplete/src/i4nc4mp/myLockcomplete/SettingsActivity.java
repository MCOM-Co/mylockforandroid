...
public class SettingsActivity extends Activity {
      ...
      getPrefs();//grabs our user's current settings for startup commands
       ...
       shake.setOnClickListener(new OnClickListener() {
                   ...
                   public void onClick(View v) {
                       ...
                       Intent i = new Intent();
               			i.setClassName("i4nc4mp.myLockcomplete", "i4nc4mp.myLockcomplete.ShakeWakeupService");
    ...
    private void startService(){
   			Intent i = new Intent();
   			//if (!customLock) i.setClassName("i4nc4mp.myLockcomplete", "i4nc4mp.myLockcomplete.LockSkipService");
   			if (secure) i.setClassName("i4nc4mp.myLockcomplete", "i4nc4mp.myLockcomplete.SecureLockService");
